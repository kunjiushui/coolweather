...
public class OtherCityDialog extends Dialog implements View.OnClickListener{
    ...
    private void initView() {
        mSureButton = (Button) findViewById(R.id.dialog_sure);
        mCancleButton = (Button)findViewById(R.id.dialog_cancle);
        mEditText = (EditText) findViewById(R.id.dialog_et_city);
